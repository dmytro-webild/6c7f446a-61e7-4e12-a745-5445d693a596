...
export const metadata: Metadata = {
  title: "Mayur Artifacts | Premium Home Décor & Artifacts in Pune",
  description: "Discover unique handcrafted artifacts and premium home décor at Mayur Artifacts. 4.8★ rated luxury gallery in Pune with 1000+ customer reviews.",
  keywords: "home décor, artifacts, Pune, luxury gallery, handcrafted items, interior design",
  metadataBase: new URL("https://mayurartifacts.com"),
  alternates: {
    canonical: "https://mayurartifacts.com",
  },
  openGraph: {
    title: "Mayur Artifacts - Premium Home Décor & Artifacts",
    description: "Explore our curated collection of unique artifacts and premium home décor. Visit our Pune showroom today.",
    url: "https://mayurartifacts.com",
    siteName: "Mayur Artifacts",
    images: [
      {
        url: "http://img.b2bpic.net/free-photo/handcrafted-wooden-decorative-vase_23-2151003058.jpg",
        alt: "Mayur Artifacts Collection",
        width: 1200,
        height: 630,
      },
    ],
  ...
  twitter: {
    ...
    title: "Mayur Artifacts - Premium Home Décor",
    description: "Discover unique handcrafted artifacts and premium décor items in Pune.",
    images: ["http://img.b2bpic.net/free-photo/handcrafted-wooden-decorative-vase_23-2151003058.jpg"],
  },
  robots: {
    index: true,
    follow: true,
